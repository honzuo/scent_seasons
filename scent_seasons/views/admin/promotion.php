            ...
            <?php foreach ($promotions as $p): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <small class="text-gray muted-block">min purchase</small>
                    </td>
                    <td>
                        ...
                        <?php else: ?>
                            <small class="text-gray muted-block">Unlimited</small>
                        <?php endif; ?>
                    </td>
                    <td>
...
<?php endif; ?>
                            <form action="../../controllers/promotion_controller.php" method="POST">
...
<div id="createModal" class="modal-overlay">
    <div class="modal-box medium">
        ...
        <form action="../../controllers/promotion_controller.php" method="POST" class="promotion-form">
            ...
            <div class="form-group">
                <label>Max Discount ($)<br><small>For percentage discounts only</small></label>
    ...
    <label for="create_is_active">
        <input type="checkbox" name="is_active" value="1" id="create_is_active" checked> 
        Active
    </label>
</div>
